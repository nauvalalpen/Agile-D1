    ...
    <body>
        ...
        <section class="hero-section">
            <div class="hero-content">
                ...
                <div class="hero-desc">Dapatkan informasi cuaca terkini dan prakiraan cuaca akurat untuk kawasan Air Terjun
                    Lubuk Hitam Lestari dan sekitarnya di Padang, Sumatera Barat.</div>
        ...
        <div class="main-content">
            <div class="container" id="weather-content">
                ...
                <div class="weather-footer" style="text-align: left">
                    ...
                    <p>
                        <strong>Sumber Data:</strong> OpenWeatherMap API & Badan Meteorologi, Klimatologi, dan Geofisika
                        (BMKG)
                    </p>
                    <p>
                    ...
                    <p>
                        Kondisi cuaca dapat berubah sewaktu-waktu. Selalu periksa kondisi terkini sebelum melakukan
                        aktivitas outdoor.
                    </p>
                    <div class="mt-3">
