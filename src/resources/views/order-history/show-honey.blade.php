                ...
                <div class="card shadow">
                    ...
                    <div class="card-body">
                            ...
                            <table class="table table-bordered">
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>{{ \Carbon\Carbon::parse($order->tanggal)->translatedFormat('d F Y') }}</td>
                                    </tr>
                                    <tr>
                                        <th>Status</th>
                                        <td>
                        ...
                        <div class="alert alert-{{ $order->status == 'pending' ? 'warning' : ($order->status == 'accepted' ? 'success' : 'danger') }}">
                            ...
                            @if ($order->status == 'pending')
                                <p>Pesanan Anda sedang dalam proses peninjauan. Kami akan memberi kabar jika sudah diproses.</p>
                            ...
                            @elseif ($order->status == 'rejected')
                                <p>Maaf, pesanan Anda telah ditolak.</p>
