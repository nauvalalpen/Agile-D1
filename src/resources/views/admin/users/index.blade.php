                                    ...
                                    <td>
                                        @if ($user->photo)
                                            <img src="{{ asset('storage/' . $user->photo) }}" alt="{{ $user->name }}"
                                                width="60" height="60" class="img-thumbnail rounded-circle">
                                        @else
                                        ...
                                        <div class="modal-content">
                                            <form action="{{ route('admin.users.update', $user->id) }}" method="POST"
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <div class="mb-3">
                                                        <label for="password{{ $user->id }}" class="form-label">Kata
                                                            Sandi <small class="text-muted">(Kosongkan jika tidak ingin
                                                                diubah)</small></label>
                                                    ...
                                                    <div class="mb-3">
                                                        <label for="photo{{ $user->id }}" class="form-label">Foto
                                                            Baru</label>
                                                        <input type="file" class="form-control"
                                                            id="photo{{ $user->id }}" name="photo"
                                                            accept="image/*">
                                                        @if ($user->photo)
                                                            <img src="{{ asset('storage/' . $user->photo) }}"
                                                                alt="{{ $user->name }}"
                                                                class="img-thumbnail mt-2 rounded-circle"
